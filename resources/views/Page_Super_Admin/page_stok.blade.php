...
<body>
    ...
    <div class="content">
        ...
        <div class="container-content">
            ...
            <table id="product-table">
                {{-- untuk kotak di atas namanya thead --}}
                <thead>
                    <tr>
                        <th>Gambar Produk</th>
                        <th>Nama Produk</th>
                ...
                <tbody>
                    @foreach ($product as $product) <!-- Pastikan penggunaan variabel di sini -->
                    {{-- kenapa tr ? karena kalau sudah di buat data baru dia bentuknya tabel bentuk row dibawahnya  --}}
                    <tr>
    ...
    <div id="product-modal" class="modal">
        <div class="modal-content">
            ...
            <form id="product-form" action="{{ route('page_stok.store') }}" method="POST">
                @csrf <!-- Token CSRF untuk keamanan -->
                <label for="product-name">Nama Produk</label>
                <input type="text" id="product-name" name="name" required> <!-- Tambah 'name' attribute -->
                <label for="product-stock">Stok</label>
                <input type="number" id="product-stock" name="stock" required> <!-- Tambah 'name' attribute -->
                <label for="product-price">Harga</label>
                <input type="number" id="product-price" name="price" required> <!-- Tambah 'name' attribute -->
                <label for="product-image">Gambar Produk</label>
                <input type="file" id="product-image" name="image" required> <!-- Tambah 'name' attribute -->
