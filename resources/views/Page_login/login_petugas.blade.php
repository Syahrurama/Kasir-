...
<body>
    ...
    <div class="container">
        <div class="gambar">
            <img src="{{url('/Asset/petugas.png')}}" alt="Forgot Password Image">
        </div>

        <div class="separator"></div>

        <div class="login">
            <h1>Login <span class="highlight">Petugas</span></h1>

            <div class="detile">
                <form action="">
                    <label for="username">Nama Pengguna :</label>
                    <input type="text" id="username" placeholder="Masukan Nama Pengguna">
                    ...
                    <div class="lupa">
                        <a href="/Page_lupa_password">Lupa Password</a>
                    </div>
