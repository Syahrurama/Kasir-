...
<body>
    ...
    <div class="container">
        <div class="gambar">
        <img src="{{url('/Asset/lupa password.png')}}" alt="Forgot Password Image">
        </div>

        <div class="separator"></div>

        <div class="login"  >
            <h1>Lupa <span class="highlight">Password</span></h1>
            ...
            <div class="detile">
                <form action="">
                    ...
                    <button type="submit" class="login-button">Selanjutnya</button>
